...
## 2024-06-13 - HabitItem isDone Calculation Testing
**Vulnerability:** None. Adding missing test coverage for `HabitItem` isDone calculation.
**Learning:** Adding comprehensive unit tests helps ensure accurate application behavior for custom objects across different interval frequencies like daily, weekly, and monthly calculations.
**Prevention:** Always write unit tests when authoring or revising custom classes that compute data dependent on dates.
